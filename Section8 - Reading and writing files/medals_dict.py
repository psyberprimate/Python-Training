...
columns = ['country', 'gold', 'silver', 'bronze'] # without rank


filename = "Section8 - Reading and writing files\country_medals.csv"

with open(filename, 'w', encoding='utf-8', newline='') as output_file:
    writer = csv.DictWriter(output_file, fieldnames=columns, extrasaction='ignore') # Without rank extrasaction='ignore' is needed
    writer.writeheader()
    #for row in medals_table: #Either use 'writerow' or 'writerows'
    #    writer.writerow(row)
