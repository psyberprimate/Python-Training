...
with open('Section8 - Reading and writing files\OlympicMedals_2020.csv', encoding='utf-8', newline='') as data, open('Section8 - Reading and writing files\medals_dict.py', 'w', encoding='utf-8') as output_file:
