...
#source_file = 'Section8 - Binary files/bm_test.txt'
source_file = 'Section8 - Binary files/vintage-halloween-bat.bmp'
source_file_i = 'vintage-halloween-bat.bmp'
inverted_file = f'Section8 - Binary files/inverted-{source_file_i}'
