...
filename = 'Section8 - Binary files/Someday.mp3'
            ...
            if frame_id in frame_types:
                ...
                if frame_id.startswith(b'T'):  # a text field
                    ...
                    if mime_type.startswith('image/'):
                        ...
                        #get file part only (without the path)
                        base_filename = path.split(filename)[1]

                        #Now remove the extension
                        base_filename = path.splitext(base_filename)[0]

                        picture_filename = f'Section8 - Binary files/{base_filename}_{apic_picture_name}.{image_type}'
